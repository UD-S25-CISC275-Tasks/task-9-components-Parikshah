...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    return {
        ...oldQuestion,
        id: id, // Assign the new ID
        name: `Copy of ${oldQuestion.name}`, // Prefix the name
...
export function mergeQuestion(
    ...
    return {
        ...contentQuestion, // Copy all properties from contentQuestion
        id: id, // Use the provided id
        name: name, // Use the provided name
        points: points, // Set points from the second question
